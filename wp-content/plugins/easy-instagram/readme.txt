...
Yes. Add thumb_size=90 to the shortcode, where 90 is the width and height of the thumbnail.
...
= Can I use Lightbox instead Thickbox for displaying larger images? =
...
You can add extra Javascript code to be run after the content has loaded, by defining the code in the Plugin Settings page, under "Extra JS to run after AJAX Easy Instagram content load".
For example, if you use the "wp-jquery-lightbox" plugin, you will have to use this in the "Extra JS .." field: doLightbox(); 
